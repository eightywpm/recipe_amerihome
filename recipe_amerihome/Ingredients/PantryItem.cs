...
{
    /// <summary>
    /// Represents a PantryItem ingredient in a recipe.
    /// </summary>
    public class PantryItem : IngredientBaseItem, IRecipeItem
    {
        #region Constructors
        /// <summary>
        ...
        public PantryItem(string productName, string unitName, bool isOrganic, double unitCost, double units)
            : base(productName, unitName, isOrganic, unitCost, enumIngredientType.Pantry, units)
        {
        ...
        /// <param name="isOrganic">True if the item is organic, false otherwise.</param>
        /// <param name="unitCost">The price per unit as denoted by the UnitName parameter.  This is used in all Calculation functions.</param>
        public PantryItem(string productName, string unitName, bool isOrganic, double unitCost)
            : base(productName, unitName, isOrganic, unitCost, enumIngredientType.Pantry)
        {
